...
enum class EActionState : uint8
{
	...
	EAS_InInventory UMETA(DisplayName = "InInventory"),
	EAS_QuickTurning UMETA(DisplayName = "QuickTurning"),
	EAS_Searching UMETA(DisplayName = "Searching"),
	EAS_StartEndCrouch UMETA(DisplayName = "StartEndCrouch"),
	EAS_OpeningDoor UMETA(DisplayName = "OpeningDoor")
};

/* Death states for Enemy */
UENUM(BlueprintType)
enum EDeathPose
{
